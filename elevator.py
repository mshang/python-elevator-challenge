...
class ElevatorLogic(object):
        ...
        def __init__(self):
            ...
            # Pending requests. A request is a pair (floor, direction), in
            # which direction can be None if the floor was selected from the
            # elevator, or a given direction if the elevator was called from a
            # floor. Telling both cases apart is actually needed.
            self._requests = set()
        ...
        def _try_add(self, floor, direction):
            ...
            if ((floor, direction) not in self._requests
                ...
                # Set direction now if possible. This gives priority to
